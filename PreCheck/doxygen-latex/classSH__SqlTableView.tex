...
Graphe d'héritage de S\-H\-\_\-\-Sql\-Table\-View\-:\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[width=188pt]{classSH__SqlTableView__inherit__graph}
\end{center}
\end{figure}


Graphe de collaboration de S\-H\-\_\-\-Sql\-Table\-View\-:\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[width=188pt]{classSH__SqlTableView__coll__graph}
\end{center}
\end{figure}
\subsection*{Signaux}
