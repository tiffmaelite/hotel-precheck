...
/*!
 ...
 \param parent
*/
    User(QString name = "", int id = 0, bool isReceptionist = false, bool isManagerX = false, bool isManagerZ = false, bool isAdministrator = false, QObject *parent = 0);
    /*!
     \brief
    ...
    */
    ...
    /*!
     ...
     \return User
    */
    static User *logIn(QString login, QString pass);
    /*!
     \brief
...
public slots:
    /*!
     ...
     \return QVariant
    */
    static QVariant exists(QVariant login) {return QVariant(User::userExists(login.toString()) || User::traineeExists(login.toString()));}
signals:
    /*!
     \brief
