...
EXPLAIN (VERBOSE true, ANALYZE true, FORMAT JSON)  SELECT gen_codeseq('SERVICESTYPES', 'CODE', 'SERVICESFAMILIES', 'LABEL', 'SERVICEFAMILY_ID');

EXPLAIN (VERBOSE true, ANALYZE true, FORMAT JSON)  SELECT gen_codeseq('SERVICES', 'CODE', 'SERVICESTYPES', 'LABEL', 'SERVICETYPE_ID');
