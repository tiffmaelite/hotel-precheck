CONNECT 'localhost:/home/tiff/Stage-IUT/app/QtQMLapp/src/PreCheck/PreCheckDB.fdb' USER 'SYSDBA' PASSWORD 'masterkey';
...
INSERT INTO SERVICES(ID, SERVICETYPE_ID, NAME, ISAVAILABLE) VALUES(0,1, 'Logement', '1');
INSERT INTO SERVICES(ID, SERVICETYPE_ID, NAME, ISAVAILABLE) VALUES(0,1, 'Logement et petit-déjeuner','1');
INSERT INTO SERVICES(ID, SERVICETYPE_ID, NAME, ISAVAILABLE) VALUES(0,1, 'Arrangement demi-pension', '1');
INSERT INTO SERVICES(ID, SERVICETYPE_ID, NAME, ISAVAILABLE) VALUES(0,1, 'Arrangement pension complète','1');
INSERT INTO SERVICES(ID, SERVICETYPE_ID, NAME, ISAVAILABLE) VALUES(0,2, 'Demi-pension', '1');
INSERT INTO SERVICES(ID, SERVICETYPE_ID, NAME, ISAVAILABLE) VALUES(0,2, 'Pension complète','1');
INSERT INTO SERVICES(ID, SERVICETYPE_ID, NAME, ISAVAILABLE) VALUES(0,3, 'Petit-déjeuner','1');
INSERT INTO SERVICES(ID, SERVICETYPE_ID, NAME, ISAVAILABLE) VALUES(0,3, 'Extras petit-déjeuner','1');
INSERT INTO SERVICES(ID, SERVICETYPE_ID, NAME, ISAVAILABLE) VALUES(0,2, 'Restaurant','1');
INSERT INTO SERVICES(ID, SERVICETYPE_ID, NAME, ISAVAILABLE) VALUES(0,2, 'Bistro','1');
INSERT INTO SERVICES(ID, SERVICETYPE_ID, NAME, ISAVAILABLE) VALUES(0,3, 'Fax','1');
INSERT INTO SERVICES(ID, SERVICETYPE_ID, NAME, ISAVAILABLE) VALUES(0,3, 'Garage', '1');
INSERT INTO SERVICES(ID, SERVICETYPE_ID, NAME, ISAVAILABLE) VALUES(0,3, 'Téléphone','1');
INSERT INTO SERVICES(ID, SERVICETYPE_ID, NAME, ISAVAILABLE) VALUES(0,2, 'Wifi chambre','0');
INSERT INTO SERVICES(ID, SERVICETYPE_ID, NAME, ISAVAILABLE) VALUES(0,3, 'Timbre', '1');
INSERT INTO SERVICES(ID, SERVICETYPE_ID, NAME, ISAVAILABLE) VALUES(0,3, 'Lingerie','1');
INSERT INTO SERVICES(ID, SERVICETYPE_ID, NAME, ISAVAILABLE) VALUES(0,3, 'Location salle','1');
INSERT INTO SERVICES(ID, SERVICETYPE_ID, NAME, ISAVAILABLE) VALUES(0,3, 'Débours', '1');
INSERT INTO SERVICES(ID, SERVICETYPE_ID, NAME, ISAVAILABLE) VALUES(0,3, 'Rabais', '1');
INSERT INTO SERVICES(ID, SERVICETYPE_ID, NAME, ISAVAILABLE) VALUES(0,2, 'Service en chambre','1');
COMMIT;
