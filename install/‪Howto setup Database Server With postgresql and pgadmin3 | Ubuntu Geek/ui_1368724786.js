...
$iTXT.ui.TooltipPosition={AR:"AR",AC:"AC",AL:"AL",CL:"CL",CR:"CR",BR:"BR",BC:"BC",BL:"BL"};$iTXT.ui.TooltipPlacer={STEP_LENGTH_PX:1,weight:{AC:90,AL:85,AR:80,BC:70,BL:65,BR:60},getHookPosition:function(){if(this.mobtEnabled){return $iTXT.core.Util.getPosition(this.hook.mobtCover);}
